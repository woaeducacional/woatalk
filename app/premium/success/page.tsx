    ...
    >
      <div className="text-center space-y-6 px-6 max-w-lg">
        ...
        <p className="text-blue-200/70 text-lg">
          Assim que o pagamento for confirmado, seu acesso será ativado automaticamente.
        </p>
        <p className="text-blue-200/50 text-sm">
          Se escolheu Pix Automático, verifique o app do seu banco para autorizar o débito.
        </p>
        <button
        ...
        <p className="text-blue-200/40 text-xs">Redirecionando automaticamente em 6 segundos...</p>
      </div>
    </div>
  )
}
